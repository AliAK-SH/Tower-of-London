...
export const FIMBEL_YOUNG_TRIALS: Trial[] = [
  { id: 1, optimalMoves: 1, start: [[], [2], [1, 3]], goal: [[3], [], [1, 2]] },
  { id: 2, optimalMoves: 1, start: [[], [], [1, 3, 2]], goal: [[2], [3], [1]] },
  { id: 3, optimalMoves: 1, start: [[], [3, 2], [1]], goal: [[2], [], [1, 3]] },
  { id: 4, optimalMoves: 2, start: [[3], [2, 1], []], goal: [[3], [], [1, 2]] },
  { id: 5, optimalMoves: 2, start: [[3], [1, 2], []], goal: [[], [1], [3, 2]] },
  { id: 6, optimalMoves: 2, start: [[], [2], [3, 1]], goal: [[], [1, 2], [3]] },
